...
<div id="skin" class="bpanel-content">
    ...
    <div class="bpanel-main-content">
        <ul class="sub-panel">
			<?php $sub_menus = array(array("title"=>__("Skins",'spatreats'), "link"=>"#appearance-skins"));
        ...
        <div id="appearance-skins" class="tab-content">
	        <div class="bpanel-box">
                <div class="box-title"><h3><?php _e('Current Skin','spatreats');?></h3></div>
                ...
                <div class="box-title"><h3><?php _e('Available Skins','spatreats');?></h3></div>
                <div class="box-content">
